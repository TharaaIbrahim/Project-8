                                    ...
                                    <div class="card-body">
                                        ...
                                        @csrf
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputPasswordConfirm" type="text" placeholder="services" name="services" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button type="submit">Create Room</button></div>
                                            </div>
                                        </form>
                                    </div>
